...
// Load prompts
const supremeOrNotItems = require('./prompts/supreme_or_not_items.json');
const ASSETS_TO_GENERATE = supremeOrNotItems.map(asset => ({
    ...asset,
...
// Main function
async function run() {
    console.log(`🚀 Starting generation for ${ASSETS_TO_GENERATE.length} Supreme or Not items...\n`);
    ...
    for (const asset of ASSETS_TO_GENERATE) {
        ...
        // Force regeneration - delete existing files if they exist
