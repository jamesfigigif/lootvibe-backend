...
-- The table is already created in admin_schema section with key-value structure
-- We will insert these settings as key-value pairs

INSERT INTO platform_settings (key, value, description) VALUES
    ('auto_approve_withdrawals', '{"enabled": false}', 'Automatically approve withdrawals below threshold'),
    ('manual_approval_threshold', '{"amount": 1000.00}', 'Withdrawals above this amount require manual approval'),
    ('withdrawal_limits', '{"min": 25.00, "max": 10000.00}', 'Minimum and maximum withdrawal amounts'),
    ('withdrawal_fee', '{"percentage": 0.00}', 'Withdrawal fee percentage')
ON CONFLICT (key) DO NOTHING;
